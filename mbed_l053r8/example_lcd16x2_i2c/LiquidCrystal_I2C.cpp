...
void LiquidCrystal_I2C::begin( I2C *i2c ) {
    _i2c = i2c;
...
void LiquidCrystal_I2C::expanderWrite(uint8_t _data){
    uint8_t _buf = _data | _backlightval;
    _i2c->write( _addr, (const char *)&_buf, 1 );
}
...
void LiquidCrystal_I2C::delay( long ms ) {
    wait_ms( ms );
}
void LiquidCrystal_I2C::delayMicroseconds( long us ) {
    wait_us( us );
}
